...
\subsection{Remote Sensing Bathymetry methods}


\subsection{Lidar Bathymetric Survey}
...
\subsection{Correcting for Refraction Effects}
...
To find bathymetric signal, a separate algorithm specifically calibrated to distinguish bathymetric signal from noise photons is required. There are several different techniques proposed in the literature. Some papers that investigate smaller sites used manual classification of the photons \parencite{Forfinski-Sarkozi2016,Thomas2021d,Babbel2021a,Albright2021}.

Other studies have used implementations of the density-based spatial clustering for applications with Noise (DBSCAN) algorithm \parencite{Ester1996}, with parameters that are set adaptively based on the local density of returns \parencite{Ma2020,Xie2020,Liu2021,}. These density-based methods are premised on the assumption that signal photons are closer together than noise photons. \parencite{Neuenschwander2019}.
...
\subsection{Wave-Kinematic Approach}
...
\subsection{Summary of Prior Research }

Prior research that has used some variation of the proposed technique are summarized in table \ref{tab:researchsummary}.
...
\begin{landscape}
      \begin{table}
            ...
            \begin{tabular}{rccccc}
                  ...
                  \citeauthor{Babbel2021a}           & 2021 & ATL03   & Parrish                       & Manual                        \\ %& N/A             & Converted to NAD83           \\
                  ...
                  \citeauthor{Coveney2021a}          & 2021 & ATL03   & First-order                   & Manual                        \\ %& TMD tidal model & -                            \\
                  \citeauthor{Datta2021}             & 2021 & ATL03   & Parrish                       & Watta                         \\ %& TMD tidal model & -                            \\
...
\begin{itemize}
      ...
      \item  Extended Kalman filter from \parencite{Ghorbanidehno2019}
            \begin{itemize}
                  ...
                  \item EKF gives accurate results in the least-squares sense, but its not practical due to the amount of matrix multiplication of large matrices and the cost of computing jacobian matrices.
            \end{itemize}
