...
\begin{itemize}
      ...
      % \item How can gaps be filled in areas with missing lidar photons? % this one can be struck because I'm starting with GEBCO
      % \item Which of the established optical SDB methods are most reliable in mangrove ecosystems? % removing SDB entirely if I can
