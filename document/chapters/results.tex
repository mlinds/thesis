...
\chapter{Results}
\pdfcomment{Compare the effect of other physical or atmospheric variables on the error, like include an entire section}\pdfcomment{Add a point density per sqaure meter for each site}\pdfcomment{average depth for each site?}\pdfcomment{how many transects actually had data?}
