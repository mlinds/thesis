...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/Florida_keys_lidar_estimated_vs_truth.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/Stcroix_tracklines.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/Stcroix_photon_map.jpg}
...
\end{table}
Overall there where X \pdfcomment{lookup number of transects} transects of ICESat-2 data available for the site, and their distribution is shown in figure \ref{fig:charlotteamalie-tracklines}.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/Charlotteamalie_lidar_estimated_vs_truth.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/Oahu_all_tracklines.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/Oahu_all_sites_photon_points.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/Oahu_combined_lidar_estimated_vs_truth.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/Oahu_combined_mountains_removed_lidar_estimated_vs_truth.jpg}
