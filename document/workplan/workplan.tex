...
\section{Develop Bathymetric Photon Identification algorithm}
...
\begin{landscape}
      \begin{figure}[htbp]
            ...
            \begin{ganttchart}[vgrid,
                        ...
                        time slot unit=day
                  ]{2022-02-15}{2022-09-010}
                  % \gantttitle{Proposed Thesis Schedule}{40} \\
                  % \ganttttitlecalendar{month}\\
                  \gantttitlecalendar{year,month=shortname}\\

                  \ganttmilestone[inline]{Kickoff Meeting}{2022-05-09}
                  \ganttmilestone[inline]{Progress Meeting 1}{2022-06-16}
                  \ganttmilestone[inline]{Progress Meeting 2}{2022-07-15}
                  \ganttmilestone[inline]{Greenlight Meeting}{2022-09-05}\\


                  \ganttgroup{Initial Literature Review}{2022-02-22}{2022-03-16} \\
                  \ganttbar{Mangroves general}{2022-02-22}{2022-03-22} \\
                  \ganttbar{Wave modeling in Mangroves}{2022-03-01}{2022-04-01} \\
                  \ganttbar{Lidar bathymetry}{2022-03-16}{2022-04-02} \\
                  \ganttbar{Optical SDB}{2022-04-01}{2022-04-22} \\

                  \ganttgroup{Find Study sites}{2022-04-15}{2022-05-16} \\
                  \ganttbar{Identify test sites}{2022-04-15}{2022-05-16} \\
                  \ganttbar{Create study area polygons}{2022-05}{2022-05-} \\

                  % \ganttgroup{Download Data}{0}{10} \\
                  % \ganttbar{Write and test download script}{3}{10} \\

                  % \ganttgroup{S/N algorithm development}{0}{10} \\
                  % \ganttbar{Develop possible options}{3}{10} \\
                  % \ganttbar{Test performance at test sites}{3}{10} \\

                  % \ganttgroup{Tidal/refraction correction}{0}{10} \\
                  % \ganttbar{Combine GTSM \& photon heights}{3}{10} \\
                  % \ganttbar{Implement Parrish method}{3}{10} \\
                  % \ganttbar{Evaluate results at test sites}{3}{10} \\

                  % \ganttgroup{Apply optical SDB}{0}{10} \\
                  % \ganttbar{Determine best methodology}{3}{10} \\
                  % \ganttbar{Implement in GEE}{3}{10} \\
                  % \ganttbar{}{3}{10} \\
