...
Figure \ref{thesis-schedule} shows the tentative schedule for the project. The early stages of some steps have already been started to asses their feasability.

\newgeometry{bottom=20mm}
\begin{landscape}
      \begin{figure}[htbp]
            \centering
            \includegraphics[height=0.8\paperwidth]{figures/gantt.png}
...
\begin{enumerate}
      ...
      \begin{enumerate}
            ...
            \begin{enumerate}
                  \item Morphodynamics
                  \item Wave-vegetation interation
